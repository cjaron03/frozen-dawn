...
public class RocketHullRecipe extends BlueprintLockedPatternRecipe {
    ...
    public RocketHullRecipe(CraftingBookCategory category) {
        super(category);
    }
    ...
    protected ItemStack result() {
        return new ItemStack(ModItems.ROCKET_HULL.get());
    }

    @Override
    public RecipeSerializer<?> getSerializer() {
        return ModRecipeSerializers.ROCKET_HULL.get();
    }
}
