...
The presentation revision gives physical holding a braced stance, a raised directing arm, a bent protective arm where equipment permits, and body/head alignment toward the inherited point. Ordinary observation retains its original presentation. Confidence, candidate selection, movement distance and commitment timing stay fixed. Only a transient boolean is synchronized for the guard pose; clients receive no new player-state or belief data. Existing required integration cases now verify body/head direction despite the player moving elsewhere, cue lifetime, recovery after knockback, and immediate erasure cleanup. These checks do not establish rendered readability; a new informed viewing and the strict blind test remain pending.
